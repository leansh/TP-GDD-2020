...
BEGIN
	...
	CREATE TABLE CUARENTENA2020.Ruta (
		ruta_id INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
	...
	SELECT DISTINCT RUTA_AEREA_CIU_DEST FROM gd_esquema.Maestra WHERE RUTA_AEREA_CODIGO IS NOT NULL order by RUTA_AEREA_CIU_DEST
    ...
    INSERT INTO CUARENTENA2020.Avion SELECT DISTINCT AVION_IDENTIFICADOR,AVION_MODELO FROM gd_esquema.Maestra WHERE AVION_IDENTIFICADOR IS NOT NULL
    ...
    CREATE TABLE CUARENTENA2020.Factura(
        ...
        compra_numero INT NULL REFERENCES CUARENTENA2020.Compra
    )

    INSERT INTO CUARENTENA2020.Factura SELECT FACTURA_FECHA,FACTURA_NRO FROM gd_esquema.Maestra
    ...
    CREATE TABLE CUARENTENA2020.Cliente(
        ...
        id_sucursal INT NULL REFERENCES CUARENTENA2020.Sucursal,
    )

    INSERT INTO CUARENTENA2020.Cliente SELECT CLIENTE_APELLIDO,CLIENTE_NOMBRE,CLIENTE_DNI,CLIENTE_FECHA_NAC,CLIENTE_MAIL,CLIENTE_TELEFONO FROM gd_esquema.Maestra
    ...
    INSERT INTO CUARENTENA2020.Vuelo SELECT VUELO_CODIGO,VUELO_FECHA_SALUDA,VUELO_FECHA_LLEGADA FROM gd_esquema.Maestra
    ...
    CREATE TABLE CUARENTENA2020.Venta(
        ...
        id_sucursal INT REFERENCES CUARENTENA2020.Sucursal
    )
