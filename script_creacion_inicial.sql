...
BEGIN
    ...
    INSERT INTO CUARENTENA2020.Cliente SELECT DISTINCT CLIENTE_APELLIDO,CLIENTE_NOMBRE,CLIENTE_DNI,CLIENTE_FECHA_NAC,CLIENTE_MAIL,CLIENTE_TELEFONO FROM gd_esquema.Maestra

    CREATE TABLE CUARENTENA2020.Venta(
	    venta_nro INT PRIMARY KEY NOT NULL IDENTITY(1,1),
